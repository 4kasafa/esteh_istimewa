...
## Corpus Check
- 86 files · ~95,007 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 534 nodes · 885 edges · 49 communities (47 shown, 2 thin omitted)
...
Cohesion: 0.10
Nodes (36): getDefaultFilter(), PAGE_SIZE_OPTIONS, ReportPanel(), ReportTable(), SmartRowMobile(), TRANSACTION_COLUMNS, TransactionTable(), filterRows() (+28 more)
...
Cohesion: 0.06
Nodes (32): ConfirmDialog(), Skeleton(), SkeletonCard(), SkeletonText(), AddBahanModal(), POPULAR_UNITS, AddCabangModal(), AddKaryawanModal() (+24 more)
