        ...
        <section className="space-y-4 rounded-3xl border border-brand-green/10 bg-white p-5 sm:p-6 card-shadow">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <RupiahInput id="pemasukan-nominal" placeholder="Nominal (Rp)" className="px-4 py-2.5" value={nominal} onChange={(e) => setNominal(e.target.value)} disabled={submitLoading} />
            </div>
            <div>
